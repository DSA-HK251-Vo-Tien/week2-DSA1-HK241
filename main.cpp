...
Toàn bộ chương trình:
    ! g++ -o main -I. -Isrc main.cpp src/DoublyLinkedList.h tests/test_basic.cpp tests/test_iterator.cpp
...
Trong đó:
    ...
    DoublyLinkedList.h: Triển khai class danh sách liên kết đôi
